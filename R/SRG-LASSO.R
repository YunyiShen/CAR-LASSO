SRGlasso <- function(formula, # a double sided formula needed, e.g. x+y~a+b
  ...
  Rcpp::sourceCpp("./src/Probit-SRG-LASSO.cpp")
  Rcpp::sourceCpp("./src/SRG-LASSO.cpp")
  Rcpp::sourceCpp("./src/graphical-LASSO.cpp")
  Rcpp::sourceCpp("./src/Probit-Graphical-LASSO.cpp")
