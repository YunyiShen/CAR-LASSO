...
res_loss_file <- "./tests/Formal/Accurancy/results/loss_CAR6.csv"
res_graph_Omega_file <- "./tests/Formal/Accurancy/results/graph_Omega_CAR6.csv"
res_graph_beta_file <- "./tests/Formal/Accurancy/results/graph_beta_CAR6.csv"
