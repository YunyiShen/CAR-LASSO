...
res_loss_file <- "./tests/Formal/Accurancy/results/loss_CAR7.csv"
res_graph_Omega_file <- "./tests/Formal/Accurancy/results/graph_Omega_CAR7.csv"
res_graph_beta_file <- "./tests/Formal/Accurancy/results/graph_beta_CAR7.csv"
