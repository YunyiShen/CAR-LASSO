...
all_Omega_k30 <- all_Omega_k30[all_Omega_k30$k==30,]
...
all_Omega_multireg <- all_Omega_k30[all_Omega_k30$algo=="multireg" & all_Omega_k30$mod!="model 6",c(1:7,16:19,20)]
...
## New plot
Omega_learning_k30 <- within(Omega_learning_k30, algo<-factor(algo, levels=c("CAR-LASSO", "CAR-ALASSO", "SRG-LASSO", "GLASSO", "GALASSO", "multireg")))
Graph_MCC <- ggplot(data = Omega_learning_k30,aes(x=algo,y = MCC)) + 
...
Graph_MCC
ggsave("Figs/MCC_k30_Asmallprior_Omega2.pdf",Graph_MCC,width = 10,height = 8,unit = "in")
...
Graph_Sensitivity
ggsave("./tests/Formal/Accurancy/Figs/Sensitivity_k30_Asmallprior_Omega.pdf",Graph_Sensitivity,width = 9,height = 5.5,unit = "in")
