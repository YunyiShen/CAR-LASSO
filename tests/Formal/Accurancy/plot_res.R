...
## New plot:
all_loss_k30 <- within(all_loss_k30, algo<-factor(algo, levels=c("CAR-LASSO", "CAR-ALASSO", "SRG-LASSO", "GLASSO", "GALASSO", "multireg", "multireg_mu0", "ad-hoc")))
Stein_k30 <- ggplot(data = all_loss_k30,aes(x=algo,y=log(steinOmega))) + 
...
Stein_k30
ggsave("Figs/Stein_k30_Asmallprior2.pdf",Stein_k30,width = 10,height = 8,unit = "in")
ggsave("Figs/Stein_k30_Asmallprior2.jpg",Stein_k30,width = 10,height = 8,unit = "in")
