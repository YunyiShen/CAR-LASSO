...
res_loss_file <- "./tests/Formal/Accurancy/k10/results/loss_Glasso.csv"
res_graph_Omega_file <- "./tests/Formal/Accurancy/k10/results/graph_Omega_Glasso.csv"

res_FP_Glasso_file_root <- "./tests/Formal/Accurancy/k10/results/graph_visual/Omega/FP_GlassoO"
res_FP_AGlasso_file_root <- "./tests/Formal/Accurancy/k10/results/graph_visual/Omega/FP_AGlassoO"
res_FP_multireg_mu0_file_root <- "./tests/Formal/Accurancy/k10/results/graph_visual/Omega/FP_multireg_mu0O"
res_FP_ad_hoc_file_root <- "./tests/Formal/Accurancy/k10/results/graph_visual/Omega/FP_ad_hocO"

res_FP_Glasso_fileB_root <- "./tests/Formal/Accurancy/k10/results/graph_visual/B/FP_GlassoB"
res_FP_AGlasso_fileB_root <- "./tests/Formal/Accurancy/k10/results/graph_visual/B/FP_AGlassoB"
res_FP_multireg_mu0_fileB_root <- "./tests/Formal/Accurancy/k10/results/graph_visual/B/FP_multireg_mu0B"
res_FP_ad_hoc_fileB_root <- "./tests/Formal/Accurancy/k10/results/graph_visual/B/FP_ad_hocB"
    ...
    for(p in ps){
        for(s in ss){
            ...
            for(mod in sigma_models){
                ...
                B_FP_Glasso <- B_FP_AGlasso <- B_FP_multireg_mu0 <- B_FP_ad_hoc <- 0 * beta
                ...
                for(i in 1:nrep){
                    ...
                    graph_A <- abs(Omega_GL_A/sample_multireg$Omega)>.5
                    ...
                    graph_Glasso <- abs(Omega_GL/sample_multireg$Omega)>.5
