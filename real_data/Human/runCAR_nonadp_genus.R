...
sourceCpp("./src/Multinomial-CAR-LASSO.cpp")
...
n_retry <- 5
for(i in 1:n_retry){
  test <- tryCatch( Multinomial_CAR_LASSO_Cpp(comp_mat,  Design_dummy, n_iter = 50000, 
...
save.image("./real_data/Human/res/CAR_full_design_genus_.005_50_without_unclass_long_chain_lambdaprior_1_1e-2_nonadp.RData")  
