...
comp_mat <- read.csv("real_data/Human/clean_data/spp_mat_.001_90.csv") %>% as.matrix()
...
test <- Multinomial_CAR_ALASSO_Cpp(comp_mat,  Design_dummy, n_iter = 15000, 
...
multireg_res <- Multinomial_CAR_multireg(data = comp_mat, design = Design_dummy,
                                        n_burn_in = 1000, n_sample = 15000, thin_by = 10)
...
save.image("./real_data/Human/CAR_full_design_spp0.005_90.RData")  
